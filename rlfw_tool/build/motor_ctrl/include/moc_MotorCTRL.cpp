...
#include <memory>
#include "../../../src/motor_ctrl/include/MotorCTRL.h"
...
QT_MOC_LITERAL(1, 10, 13), // "emitTopicData"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11) // "emitSrvData"

    },
    "MotorCTRL\0emitTopicData\0\0emitSrvData"
};
...
void MotorCTRL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->emitSrvData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MotorCTRL::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MotorCTRL::emitTopicData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MotorCTRL::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MotorCTRL::emitSrvData)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MotorCTRL::emitTopicData(QString _t1)
{
...
// SIGNAL 1
void MotorCTRL::emitSrvData(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
