...
bool rlfw_msgs__msg__joint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rlfw_msgs.msg._joint.Joint", full_classname_dest, 26) == 0);
  }
  rlfw_msgs__msg__Joint * ros_message = _ros_message;
  {  // jointname
  ...
  {  // joint_id
    ...
    ros_message->joint_id = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // pos
  ...
  {  // number_laps
    PyObject * field = PyObject_GetAttrString(_pymsg, "number_laps");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->number_laps = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // vel
  ...
  {  // other
    PyObject * field = PyObject_GetAttrString(_pymsg, "other");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->other.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'other'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * rlfw_msgs__msg__joint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rlfw_msgs.msg._joint");
  ...
  {  // joint_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->joint_id);
    {
  ...
  {  // number_laps
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->number_laps);
    {
      int rc = PyObject_SetAttrString(_pymessage, "number_laps", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // other
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "other");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->other.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->other.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->other.size * sizeof(float));
      assert(data != NULL);
