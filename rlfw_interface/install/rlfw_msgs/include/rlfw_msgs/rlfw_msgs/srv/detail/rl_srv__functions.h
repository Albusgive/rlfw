...
#ifndef RLFW_MSGS__SRV__DETAIL__RL_SRV__FUNCTIONS_H_
#define RLFW_MSGS__SRV__DETAIL__RL_SRV__FUNCTIONS_H_
...
/// Create srv/RLSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rlfw_msgs__srv__RLSrv_Request__init().
...
/// Destroy srv/RLSrv message.
/**
 * It calls
 * rlfw_msgs__srv__RLSrv_Request__fini()
...
/// Check for srv/RLSrv message equality.
/**
...
/// Initialize array of srv/RLSrv messages.
/**
...
/// Finalize array of srv/RLSrv messages.
/**
 * It calls
 * rlfw_msgs__srv__RLSrv_Request__fini()
...
/// Create array of srv/RLSrv messages.
/**
 * It allocates the memory for the array and calls
 * rlfw_msgs__srv__RLSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RLSrv messages.
/**
 * It calls
 * rlfw_msgs__srv__RLSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RLSrv message array equality.
/**
...
/// Copy an array of srv/RLSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rlfw_msgs__srv__RLSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rlfw_msgs
...
/**
 * It calls
 * rlfw_msgs__srv__RLSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rlfw_msgs
...
/**
 * It allocates the memory for the array and calls
 * rlfw_msgs__srv__RLSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rlfw_msgs
...
/**
 * It calls
 * rlfw_msgs__srv__RLSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RLFW_MSGS__SRV__DETAIL__RL_SRV__FUNCTIONS_H_
