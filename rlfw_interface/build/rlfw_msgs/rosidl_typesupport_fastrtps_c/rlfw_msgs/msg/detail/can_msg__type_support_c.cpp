...
#include "rlfw_msgs/msg/detail/can_msg__rosidl_typesupport_fastrtps_c.h"
...
using _CanMsg__ros_msg_type = rlfw_msgs__msg__CanMsg;
...
size_t get_serialized_size_rlfw_msgs__msg__CanMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CanMsg__ros_msg_type * ros_message = static_cast<const _CanMsg__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name msgtype
  {
    size_t item_size = sizeof(ros_message->msgtype);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name len
...
static uint32_t _CanMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rlfw_msgs__msg__CanMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rlfw_msgs
size_t max_serialized_size_rlfw_msgs__msg__CanMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rlfw_msgs__msg__CanMsg;
    is_plain =
      (
...
static size_t _CanMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rlfw_msgs__msg__CanMsg(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rlfw_msgs, msg, CanMsg)() {
