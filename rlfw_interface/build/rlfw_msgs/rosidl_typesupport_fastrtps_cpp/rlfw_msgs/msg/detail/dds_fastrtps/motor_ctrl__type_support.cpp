...
#include "rlfw_msgs/msg/detail/motor_ctrl__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rlfw_msgs::msg::MotorCtrl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rlfw_msgs::msg::MotorCtrl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rlfw_msgs::msg::MotorCtrl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorCtrl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rlfw_msgs::msg::MotorCtrl *>(
...
static size_t _MotorCtrl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorCtrl(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorCtrl__callbacks = {
  "rlfw_msgs::msg",
  "MotorCtrl",
...
static rosidl_message_type_support_t _MotorCtrl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorCtrl__callbacks,
...
{
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_MotorCtrl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rlfw_msgs, msg, MotorCtrl)() {
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_MotorCtrl__handle;
}
