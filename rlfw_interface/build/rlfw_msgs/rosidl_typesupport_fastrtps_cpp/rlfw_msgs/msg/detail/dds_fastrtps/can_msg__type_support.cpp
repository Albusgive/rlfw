...
#include "rlfw_msgs/msg/detail/can_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rlfw_msgs::msg::CanMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rlfw_msgs::msg::CanMsg & ros_message)
{
  // Member: comname
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rlfw_msgs::msg::CanMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rlfw_msgs::msg::CanMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rlfw_msgs::msg::CanMsg *>(
    untyped_ros_message);
...
get_message_type_support_handle<rlfw_msgs::msg::CanMsg>()
{
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_CanMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rlfw_msgs, msg, CanMsg)() {
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_CanMsg__handle;
}
