...
#include "rlfw_msgs/msg/detail/remote__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rlfw_msgs::msg::Remote & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: remotename
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.remotename,
    cdr);
  // Member: key
  {
    cdr << ros_message.key;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rlfw_msgs::msg::Remote & ros_message)
{
  // Member: remotename
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rlfw_msgs::msg::Remote;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rlfw_msgs::msg::Remote *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rlfw_msgs::msg::Remote *>(
    untyped_ros_message);
...
{
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_Remote__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rlfw_msgs, msg, Remote)() {
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_Remote__handle;
}
