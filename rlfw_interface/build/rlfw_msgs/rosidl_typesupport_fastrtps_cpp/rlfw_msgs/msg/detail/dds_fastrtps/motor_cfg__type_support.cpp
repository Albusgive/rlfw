...
#include "rlfw_msgs/msg/detail/motor_cfg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rlfw_msgs::msg::MotorCfg & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.parameter_type;
  // Member: parameter
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rlfw_msgs::msg::MotorCfg & ros_message)
{
  // Member: joint
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rlfw_msgs::msg::MotorCfg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rlfw_msgs::msg::MotorCfg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rlfw_msgs::msg::MotorCfg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorCfg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rlfw_msgs::msg::MotorCfg *>(
...
static size_t _MotorCfg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorCfg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorCfg__callbacks = {
  "rlfw_msgs::msg",
  "MotorCfg",
...
static rosidl_message_type_support_t _MotorCfg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorCfg__callbacks,
...
{
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_MotorCfg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rlfw_msgs, msg, MotorCfg)() {
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_MotorCfg__handle;
}
