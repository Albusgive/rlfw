...
#include "rlfw_msgs/msg/detail/motor__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rlfw_msgs::msg::Motor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rlfw_msgs::msg::Motor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rlfw_msgs::msg::Motor *>(
    untyped_ros_message);
...
{
  return &rlfw_msgs::msg::typesupport_fastrtps_cpp::_Motor__handle;
}
