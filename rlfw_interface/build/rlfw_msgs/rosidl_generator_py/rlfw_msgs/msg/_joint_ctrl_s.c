...
bool rlfw_msgs__msg__joint_ctrl__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rlfw_msgs.msg._joint_ctrl.JointCtrl", full_classname_dest, 35) == 0);
  }
  rlfw_msgs__msg__JointCtrl * ros_message = _ros_message;
  {  // jointname
...
{
  /* NOTE(esteve): Call constructor of JointCtrl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rlfw_msgs.msg._joint_ctrl");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointCtrl");
