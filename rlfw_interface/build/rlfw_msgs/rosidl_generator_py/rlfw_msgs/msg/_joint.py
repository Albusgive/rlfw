...
class Joint(metaclass=Metaclass_Joint):
    ...
    def __init__(self, **kwargs):
        ...
        self.other = array.array('f', kwargs.get('other', []))
    ...
    def joint_id(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'joint_id' field must be an integer in [-128, 127]"
    ...
    def other(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'other' array.array() must have the type code of 'f'"
            self._other = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'other' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._other = array.array('f', value)
